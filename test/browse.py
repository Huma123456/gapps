    ...
    for i in subcateg:#get the list of all apps of a subcategory
        ...
        for j in app:
            ...
            if j['docid'] not in prevappid:   
                ...
                j.get('details').get("appDetails").get("developerWebsite"),j.get('details').get("appDetails").get("numDownloads"),
                j.get('details').get("appDetails").get("packageName"),j.get('details').get("appDetails").get("recentChangesHtml"),
